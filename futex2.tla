...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "55ce3c" /\ chksum(tla) = "543083f7")
\* Process p at line 77 col 1 changed to p_
\* Parameter addr of procedure futex_wait at line 43 col 22 changed to addr_
